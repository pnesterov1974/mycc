    ...
    public class ValidateModel
    {
        ...
        public bool Validate(bool useKeyFieldsWhenValidating = false)
        {
            ...
            if (modelHasSourceDbName)
            {
                ...
                try
                {
                    string conn = Connections.GetConnectionStringByName(this.EtlModel.SourceDbName);
            ...
            if (modelHasTargetDbName)
            {
                ...
                if (modelHasTargetDbName)
                {
                    ...
                    try
                    {
                        string conn = Connections.GetConnectionStringByName(this.EtlModel.TargetDbName);

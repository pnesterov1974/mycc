    ...
    public static class ConnectionStrings
    {
        ...
        public static void InitConnectionStrings(TargetDb tdb)
        {
            switch (tdb)
            {
                case TargetDb.mssql:
                    {
                        ConnectionsDict.Add("kladrStage", ConnectionStrings.buildMsSqlConnectionString(serverName: "ETL-SSIS-D-02", dbName: "kladrStage"));
                        ConnectionsDict.Add("kladrWork", ConnectionStrings.buildMsSqlConnectionString(serverName: "ETL-SSIS-D-02", dbName: "etln"));
                        ...
                        ConnectionsDict.Add("myDWH", ConnectionStrings.buildMsSqlConnectionString(serverName: "ETL-SSIS-D-02", dbName: "mydwh"));
                        ConnectionsDict.Add("techDb", ConnectionStrings.buildMsSqlConnectionString(serverName: "ETL-SSIS-D-02", dbName: "techdb"));
                        ConnectionsDict.Add("trdBuffer", ConnectionStrings.buildMsSqlConnectionString(serverName: "comp-db-p-02", dbName: "_trdHR_buf"));
                        break;
                    }
                case TargetDb.pgsql:
                    {

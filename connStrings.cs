    ...
    public static class ConnectionStrings
    {
        ...
        public static void InitConnectionStrings(TargetDb tdb)
        {
            switch (tdb)
            {
                ...
                case TargetDb.pgsql:
                    {
                        ConnectionsDict.Add("kladrRaw", ConnectionStrings.buildPgSqlConnectionString(serverName: "localhost", dbName: "kladr"));
                        ConnectionsDict.Add("kladrWork", ConnectionStrings.buildPgSqlConnectionString(serverName: "localhost", dbName: "kladr"));
                        break;
                    }
            }
        }
